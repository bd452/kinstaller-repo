...
- `apps/com.bd452.ksubstrate/vendor/Dobby` — Dobby inline-hook engine (pinned commit)
...
[`docs/kindle-substrate.md`](docs/kindle-substrate.md). The root build now
compiles and publishes the runtime package plus its self-contained demo after
the existing FBInk and SignalKit packages.
